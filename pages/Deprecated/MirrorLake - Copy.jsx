...
const speciesOptions = [
  { name: 'Largemouth Bass', icon: '/assets/wanted/largemouth_bass.png' },
  { name: 'Tilapia', icon: '/assets/wanted/tilapia.png' },
  { name: 'Catfish', icon: '/assets/wanted/catfish.png' },
  { name: 'Redfish', icon: '/assets/wanted/redfish.png' },
  { name: 'Snook', icon: '/assets/wanted/snook.png' },
